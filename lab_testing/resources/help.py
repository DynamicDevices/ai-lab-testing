    ...
    return {
        ...
        "quick_start": {
            ...
            "foundries_vpn_setup": [
                ...
                "3. Setup VPN: Ask AI 'Set up Foundries VPN' or call 'setup_foundries_vpn(auto_generate_config=True)'",
                "4. Edit config: Fill in your private key and assigned IP in the generated config file",
                "5. Connect: Call 'setup_foundries_vpn()' again after editing config",
                "6. Verify: 'verify_foundries_vpn_connection()' to test connectivity",
                "",
                "**Manual Method:**",
                "1. Get VPN config from FoundriesFactory web interface",
                "2. Place config in: ~/.config/wireguard/foundries.conf",
                "3. Connect: 'connect_foundries_vpn()'",
                "4. List devices: 'list_foundries_devices()' to see Foundries devices",
            ],
            "first_device_access": [
        ...
        "usage": {
            ...
            "llm_guidance": [
                ...
                "  - **Foundries VPN:** Use 'setup_foundries_vpn(auto_generate_config=True)' for easiest setup",
