    ...
    return {
        ...
        "tools": {
            ...
            "foundries_vpn_management": {
                ...
                "list_foundries_devices": "List devices accessible via Foundries VPN. Uses fioctl API to list devices in the FoundriesFactory. Returns device information including name, target, status, apps, and WireGuard status. VPN IP addresses are automatically included from cache if available. Requires fioctl CLI tool to be installed and configured.",
